      ...
      <main className="main-principal">
        <section className="main-principal-section-1">
          <div className="main-principal-section-1--title">
            ...
            Swap Deal es una plataforma innovadora que te permite intercambiar artículos<br/> que ya no necesitas por aquellos que deseas. Simplemente publica lo que tienes, <br/> busca lo que quieres  y realiza el intercambio con otros usuarios de manera rápida <br/>y segura. Descubre una nueva forma de obtener lo que necesitas sin gastar dinero.
            </p>
          </div>
        </section>
        ...
        <section className="main-principal-section-2">
          ...
          <section className="main-principal-section-2--cards">
            <article className="--card">
              ...
              <p className="--card-body">Muebles, decoración, utensilios de cocina y más.</p>
            </article>
            <article className="--card">
              <span className="--card__icon eye"></span>
              <p className="--card-title">Tecnología</p>
              <p className="--card-body">Teléfonos móviles, ordenadores, accesorios y más.
              </p>
            </article>
            <article className="--card">
              <span className="--card__icon money"></span>
              <p className="--card-title">Moda y Accesorios</p>
              <p className="--card-body">Ropa, calzado, joyas y complementos.</p>
            </article>
            <article className="--card">
              <span className="--card__icon tick"></span>
              <p className="--card-title">Deportes</p>
              <p className="--card-body">Equipamiento deportivo, ropa deportiva y accesorios.
              </p>
            </article>
            <article className="--card">
              <span className="--card__icon tick"></span>
              <p className="--card-title">Entretenimiento</p>
              <p className="--card-body">Libros, videojuegos, películas y música.
              </p>
            </article>
            <article className="--card">
              <span className="--card__icon tick"></span>
              <p className="--card-title">Herramientas y Materiales</p>
              <p className="--card-body">Herramientas, materiales de construcción y más.
              </p>
            </article>
            <article className="--card">
              <span className="--card__icon tick"></span>
              <p className="--card-title">Salud y Belleza</p>
              <p className="--card-body">Productos de cuidado personal, maquillaje y equipos de ejercicio.
              </p>
            </article>
            <article className="--card">
              <span className="--card__icon tick"></span>
              <p className="--card-title">Mascotas</p>
              <p className="--card-body">Accesorios para mascotas, alimentos y juguetes
              </p>
            </article>
          </section>
        </section>
        ...
        <section className="main-principal-section-3">
          ...
          <section className="main-principal-section-2--cards">
            <article className="--card">
              ...
              <p className="--card-body"> "Gracias a Swap Deal, he podido intercambiar mis viejos libros por una<br/> bicicleta que quería desde hace tiempo. ¡Es una forma fantástica de reciclar y obtener lo que necesitas!"</p>
            </article>
            <article className="--card">
              <span className="--card__icon eye"></span>
              <p className="--card-title">Carlos Gómez</p>
              <p className="--card-body">"Me encanta Swap Deal porque es fácil de usar y me ha permitido deshacerme de cosas que ya no usaba. Además, he encontrado artículos geniales a cambio. ¡Totalmente recomendado!"
              </p>
            </article>
            <article className="--card">
              <span className="--card__icon money"></span>
              <p className="--card-title">Laura Fernández</p>
              <p className="--card-body">"Nunca pensé que sería tan sencillo intercambiar artículos. La comunidad es increíble y siempre hay algo interesante para permutar. ¡Swap Deal ha cambiado la manera en que obtengo lo que necesito!"</p>
            </article>
            <article className="--card">
              <span className="--card__icon tick"></span>
              <p className="--card-title">Ana Rodríguez</p>
              <p className="--card-body">"Swap Deal ha sido una revelación para mí. He podido intercambiar ropa que ya no usaba por electrodomésticos que necesitaba para mi hogar. Es una plataforma increíble que facilita el trueque de manera muy sencilla y segura."
              </p>
            </article>
            <article className="--card">
              <span className="--card__icon tick"></span>
              <p className="--card-title">Javier Martínez</p>
              <p className="--card-body">"Nunca pensé que podría encontrar un lugar tan fácil y eficiente para intercambiar herramientas y materiales de construcción. Swap Deal no solo me ha ayudado a ahorrar dinero, sino que también me ha permitido conocer a personas con intereses similares. ¡Una experiencia fantástica!"
              </p>
            </article>
          </section>
        </section>
