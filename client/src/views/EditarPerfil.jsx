...
const handleSubmit = async (e) => {
    e.preventDefault();
    try {
        console.log("Datos enviados en la solicitud:", { // Agrega este console.log
            nombre,
            apellido,
            email,
            password,
    ...
    const response = await axios.put(`http://localhost:3002/usuario/${user.documento}`, {
        nombre: nombre,
        apellido: apellido,
        email: email,
        password: password,
    ...
    <div className="container">
        <div className="caja-info">
            ...
            <Link to="/Perfil">
            <a href="" className="volver">Volver al perfil</a>
            </Link>
            ...
            <div className="formas">
                <label>Nombre:</label>
                <input type="text" className="nombr" value={nombre} onChange={(e) => setNombre(e.target.value)} />
            </div>
    
            <div className="formas">
                <label>Apellido:</label>
                <input type="text" className="apelli" value={apellido} onChange={(e) => setApellido(e.target.value)} />
            </div>
    
            <div className="formas">
                <label>Email:</label>
                <input type="email" className="mail" value={email} onChange={(e) => setEmail(e.target.value)} />
            </div>
